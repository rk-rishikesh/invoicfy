  ...
  return (
    <Html>
      <Head>
        ...
        <meta name="application-name" content="Payment Chowk" />
        <meta
          name="keywords"
        ...
        <meta name="apple-mobile-web-app-title" content="Payment Chowk" />
        <meta name="apple-mobile-web-app-capable" content="yes" />

        <meta property="og:url" content="https://warp.hyperlane.xyz" />
        <meta property="og:title" content="Payment Chowk" />
