function Section4() {
  return (
    <div className="flex flex-col items-start bg-[#E7ECEF] py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-32 text-[#274C77]">
      ...
      <button className="font-golos bg-black text-[#A3CEF1] py-4 px-4 sm:px-6 rounded-md hover:bg-[#070c10] transition duration-300 text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl">
        Create Invoice
      </button>
    </div>
  );
