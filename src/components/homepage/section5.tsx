function Section5() {
  return (
    <>
      <div className="bg-[#1c2541] text-white p-4 sm:p-8 md:p-16 lg:p-20 xl:p-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 sm:gap-8 relative">
          <div className="flex flex-col items-start overflow-hidden">
            <div className="text-text-white text-lg font-bold">How do I pay?</div>
          ...
          <div className="flex flex-col items-start overflow-hidden">
            <div className="text-text-white text-lg font-bold">Is it safe?</div>
            <div className="text-text-white">
          ...
          <div className="flex flex-col items-start overflow-hidden">
            <div className="text-text-white text-lg font-bold">Any additional fees?</div>
            <div className="text-text-white">
